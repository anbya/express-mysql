                        ...
                        (error, results, fields) => {
                            if (error)  {
                                ...
                                if(results.length >= 1){
                                    ...
                                    connection.query(`INSERT INTO user values("${id_user}","${req.body.namauser}","${req.body.emailuser}","${req.body.gender}","${req.body.bloodtype}","${req.body.rhfactor}","${hash}","")`,(error,result,field)=> {
                                        if (error){
                                            res.status(400).send({
                                                error
                                            });
