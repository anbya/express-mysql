            ...
            (error, results, fields) => {
                if (error)  {
                    ...
                    if(results.length >= 1){
                        ...
                        connection.query(`INSERT INTO events values('${idevents}','${req.body.namaevents}','${req.body.startdate}','${req.body.enddate}','${req.body.starttime}','${req.body.endtime}','${req.body.eventlocation}','${req.body.eoname}','${req.body.pic}','${req.body.picphone}','${req.body.eooffice}','NEEDAPPROVAL','')`,(error,result,field)=> {
                            if (error){
                                res.status(400).send({
                                    error
                                });
